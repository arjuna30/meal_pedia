...
class FavouriteRecord extends DataClass implements Insertable<FavouriteRecord> {
  final String idMeal;
  ...
  FavouriteRecord(
      ...
      this.strMeasure20,
      this.strSource});
  factory FavouriteRecord.fromData(
  ...
  factory FavouriteRecord.fromJson(Map<String, dynamic> json,
  ...
  @override
  String toString() {
    return (StringBuffer('FavouriteRecord(')
          ..write('idMeal: $idMeal, ')
...
class FavouritesCompanion extends UpdateCompanion<FavouriteRecord> {
  ...
  FavouritesCompanion.insert({
    ...
    this.strSource = const Value.absent(),
        ...
        strMeasure2 = Value(strMeasure2),
        strMeasure3 = Value(strMeasure3);
  static Insertable<FavouriteRecord> custom({
...
class $FavouritesTable extends Favourites
    with TableInfo<$FavouritesTable, FavouriteRecord> {
  ...
  @override
  VerificationContext validateIntegrity(Insertable<FavouriteRecord> instance,
  ...
  @override
  FavouriteRecord map(Map<String, dynamic> data, {String? tablePrefix}) {
    return FavouriteRecord.fromData(data, _db,
